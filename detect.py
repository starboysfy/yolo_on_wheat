...
def run(
        ...
        data='data/spike.yaml',  # dataset.yaml path
        imgsz=(640, 640),  # inference size (height, width)
        conf_thres=0.01,  # confidence threshold
        iou_thres=0.02,  # NMS IOU threshold
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='best2.pt', help='model path(s)')
    parser.add_argument('--source', type=str, default='data/test', help='file/dir/URL/glob, 0 for webcam')
    parser.add_argument('--data', type=str, default='data/spike.yaml', help='(optional) dataset.yaml path')
